export default {
  ...
  'seo.common.des':
    'KuChain serves DApps with exchange and connection of trust value at high efficiency and low cost.',
  ...
  'why.intro.item1.desc':
    'KuChain is an operating system of trust circulation that anyone can resort to building their own decentralized financial services.',
  ...
  'why.intro.item3.desc':
    'In KuChain, developers can build multiple decentralized financial services including Dex, Loans, and stable coins.',
  'why.arch.title': 'KuChain Architecture',
  'why.arch.desc':
    'KuChain uses Tendermint BFT consensus engine based on the Cosmos SDK which allows KuChain to better support the cross-chain and on-chain assets exchange. The following figure has illustrated the product architecture of KuChain:',
  'why.gover.title': 'Open and Decentralized',
  'why.gover.desc':
    'KuChain is a flexible and autonomous economic entity with a low entry barrier. By opening its source infrastructure to the public, the developers and entrepreneurs are able to build their own user-friendly decentralized products.',
  'why.gover.item1.title': 'Security',
  'why.gover.item1.desc':
    'The license-free network and decentralized validating nodes strongly guaranteed the security and stability of KuChain network.',
  'why.gover.item2.title': 'Community Governance',
  'why.gover.item2.desc':
    'KuChain emphasizes the concept of community-first, underlining the idea of group decision-making in ecosystem development.',
  'why.gover.item3.title': 'High Efficiency & Low Cost',
  'why.gover.item3.desc':
    "KuChain's economic model has ensured the low resource consumption onchain.",
  'why.gover.item4.title': 'Open Source Code',
  'why.gover.item4.desc':
    'KuChain will go hand in hand with developers and the community to jointly create an efficient decentralized service with low entry barrier.',
  ...
  'why.better.item1.desc':
    'Safe, efficient, transparent and low-cost asset exchange solution, supporting one-click deployment of Dex.',
